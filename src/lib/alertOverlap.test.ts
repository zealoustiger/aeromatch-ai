...
function aircraft(over: Partial<{ make: string; model: string; state: string; minPrice: string; maxPrice: string; minYear: string; maxYear: string; minTt: string; maxTt: string; dealOnly: boolean }> = {}) {
  return {
