...
export default async function CoOwnershipGuidePage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <article className="text-slate-700">
        ...
        <AlertSignup noun="partnership" sourcePath="/partnerships" source="guide_aircraft_co_ownership" className="mt-10" matchCount={matchResult?.count} />
      </article>
