...
export default async function AirportPage({
  ...
  const atAirport = rankByCompleteness(allListings.filter((l) => l.home_airport === airport.icao))
  const nearby = rankByCompleteness(allListings.filter((l) => l.home_airport !== airport.icao))
