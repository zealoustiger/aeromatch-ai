...
export default function PostSeekerListingForm({
  ...
  return (
    <form ref={formRef} action={action} onSubmit={onFormSubmit} className="space-y-5">
      ...
      {/* About you — description visible by default so seekers are prompted to write one */}
      <section className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
        <h2 className="mb-1 border-b border-slate-100 pb-2 text-base font-semibold text-slate-800">About you</h2>
        <p className="mb-3 text-xs text-slate-500">Tell owners about yourself — your experience, how you fly, what you&apos;re looking for in a partnership, and anything that makes you a great partner. A good description is the single biggest factor in getting a serious reply.</p>
